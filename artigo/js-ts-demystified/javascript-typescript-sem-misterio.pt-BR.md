...
title: "JavaScript e TypeScript sem mistério: o que são, por que existem e qual é a diferença?"
slug: "/article/js-ts-demystified"
description: "Um guia introdutório para entender JavaScript, TypeScript, a história das duas linguagens, onde são usadas, como se relacionam e quando escolher cada uma."
language: "pt-BR"
tags:
  - JavaScript
  - TypeScript
...
[O que é ECMAScript e por que existem ES2015, ES2020 e ESNext?](/blog/o-que-e-ecmascript)
...
[Runtime, compilador e build: o que significam esses termos?](/blog/runtime-compilador-build)
...
[TypeScript em runtime: por que os tipos não validam uma API sozinhos?](/blog/typescript-runtime-validacao)
...
[TSConfig sem mistério: entendendo a configuração de um projeto TypeScript](/blog/tsconfig-sem-misterio)
...
[Inferência de tipos no TypeScript: quando você não precisa escrever o tipo](/blog/typescript-inferencia-de-tipos)
...
1. [Variáveis e tipos de valores em JavaScript](/blog/javascript-variaveis-tipos)
2. [Funções em JavaScript](/blog/javascript-funcoes)
3. [Objetos e arrays em JavaScript](/blog/javascript-objetos-arrays)
4. [O que é TypeScript? Tipos e inferência na prática](/blog/typescript-tipos-inferencia)
5. [JavaScript assíncrono: Promises e async/await](/blog/javascript-promises-async-await)
6. [Módulos JavaScript: import, export, ESM e CommonJS](/blog/javascript-modulos)
7. [TSConfig sem mistério](/blog/tsconfig-sem-misterio)
