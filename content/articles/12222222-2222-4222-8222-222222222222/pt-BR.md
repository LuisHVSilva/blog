---
translationId: 22222222-2222-4222-8222-222222222222
locale: pt-BR
slug: tsconfig-sem-misterio
...
sourceRevision: 2f06f53dd2a0649bddbc3d2ce9f55fe84fc043b20152446567cdf874a4f6e033
---
...
> **Leitura relacionada:** O que strict realmente ativa?
>
...
> **Leitura relacionada:** CommonJS, ESM, import e export
>
...
> **Leitura relacionada:** Runtime, compilador e bundler
>
...
> **Leitura relacionada:** JavaScript: o que realmente é executado?
>
> Base para entender por que TypeScript não substitui o runtime.

> **Leitura relacionada:** TypeScript: tipos, inferência e análise estática
>
> O que o TypeScript adiciona ao desenvolvimento JavaScript.

> **Leitura relacionada:** strict sem medo
>
> Como o modo rigoroso muda a análise do código.

> **Leitura relacionada:** target e versões do JavaScript
>
> Como relacionar o TSConfig ao ambiente de destino.

> **Leitura relacionada:** Módulos: CommonJS, ESM e NodeNext
>
> O contexto necessário para entender `module` e `moduleResolution`.

> **Leitura relacionada:** include, exclude e o grafo do projeto
>
