...
export class PublicationRevision extends EntityAuditBase<PublicationRevisionProps & {readonly id: string}, PublicationRevision> {
    constructor(props: PublicationRevisionProps) {
        super({...props, id: JSON.stringify([props.singleton])});
        Object.freeze(this);
    }

    protected recreate(props: PublicationRevisionProps): PublicationRevision {
        return new PublicationRevision(props);
    }
