...
export class SeriesArticle extends EntityBase<SeriesArticleProps & {readonly id: string}, SeriesArticle> {
    constructor(props: SeriesArticleProps) { super({...props, id: JSON.stringify([props.seriesId, props.articleId])}); Object.freeze(this); }
    protected recreate(props: SeriesArticleProps): SeriesArticle { return new SeriesArticle(props); }
