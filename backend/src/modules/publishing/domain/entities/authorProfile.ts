...
export type AuthorProfileProps = Readonly<{
    id: string;
    displayName: string;
    profileSlug: string;
    bio: string | null;
...
export class AuthorProfile extends EntityAuditBase<AuthorProfileProps, AuthorProfile> {
    constructor(props: AuthorProfileProps) {
        super(props);
        Object.freeze(this);
    }

    protected recreate(props: AuthorProfileProps): AuthorProfile {
        return new AuthorProfile(props);
    }
