...
export type ArticlePathProps = Readonly<{
    locale: Locale;
    slug: string;
...
export class ArticlePath extends EntityBase<ArticlePathProps & {readonly id: string}, ArticlePath> {
    constructor(props: ArticlePathProps) {
        super({...props, id: JSON.stringify([props.locale, props.slug])});
        Object.freeze(this);
    }

    protected recreate(props: ArticlePathProps): ArticlePath {
        return new ArticlePath(props);
    }
