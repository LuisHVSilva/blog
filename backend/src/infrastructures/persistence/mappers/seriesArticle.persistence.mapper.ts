import {SeriesArticle, type SeriesArticleProps} from '../../../modules/publishing/domain/entities/seriesArticle';
...
export class SeriesArticlePersistenceMapper {
    ...
    static toPersistence(entity: SeriesArticle): SeriesArticleProps {
