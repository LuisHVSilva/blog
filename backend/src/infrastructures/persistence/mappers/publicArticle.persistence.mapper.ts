...
export type ArticleReadRow = {article_id: string; translation_id: string; locale: Locale; slug: string; title: string; description: string; difficulty: Difficulty; published_at: Date; updated_at: Date; reading_minutes: number; body_markdown?: string; seo?: ArticleDetail['seo']; author: ArticleSummary['author']; tags: ArticleSummary['tags']; series: ArticleSummary['series']; bio?: string; links?: readonly string[]; alternates?: {locale: Locale; slug: string}[]; kind?: string; position?: number};
