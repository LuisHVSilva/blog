export const visible = `t.status='published' AND a.archived_at IS NULL`;
export const columns = `a.id article_id,t.id translation_id,t.locale,t.slug,t.title,t.description,a.difficulty,t.published_at,t.updated_at,t.reading_minutes,
...
export const joins = `FROM article_translations t JOIN articles a ON a.id=t.article_id JOIN author_profiles au ON au.id=a.author_id`;
