...
const destinations = [
  ...
  { title: "Arquitetura backend aplicada a Base TS/Node", description: "Regras de neg\u00f3cio, infraestrutura e testes", href: "/article/backend-architecture-ts-node-foundation", placeholder: false },
];
